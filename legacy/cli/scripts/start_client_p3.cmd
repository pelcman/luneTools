@echo off
chcp 932 >nul
title LvKSync クライアント - 3P
set PORT=47801

cls
echo ==========================================================
echo   LvKSync クライアント   あなたは 3P です
echo ==========================================================
echo.
echo   あなたの操作キー :  A S D F  と  G H
echo.
...
"%~dp0bin\LvKSyncClient.exe" --host %HOST% --port %PORT% --slot 3 --index 0 --local-keys D,S,F,A,G,H
